...
/* CFGDRIFT-2026-09-20: the vocabulary and the config moved to nfl_cfg.js so the rebuild
   entry point cannot drift from this one. Same values, one file. */
const { CFG, applyVocabulary } = require('./nfl_cfg.js');
applyVocabulary(Draft);
