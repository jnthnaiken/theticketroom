import math, statistics as st, json, unicodedata
...
for (gm,gn,gt,wf,away,home,asp,hsp) in GAMES:
    ...
    wx[str(gn)]={'emoji':em,'lean':lean,'factor':wf,'park':gm,'cond':cond,'rain':'0% rain'}
# ---- season ledger: carry forward through-June13 state, fold in the graded June14 night (flat 1u-per-combo) ----
prior=json.load(open('/home/claude/slate0614/D_0614.json'))['meta']['season']
night=json.load(open('/home/claude/slate0614/sample_log_0614.json'))['nights']['2026-06-14']['tickets']
...
assert abs(_tot-125.65)<0.01, f"season fold = {_tot}, expected +125.65"
...
print(f"season folded through Jun 14: {_tot:+.2f}u | maxAT={maxAT}")
# report
